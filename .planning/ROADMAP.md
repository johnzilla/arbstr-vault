...
- ✅ **v1.1 Internal Billing API** — Phases 5-6 (shipped 2026-04-03)
...
<details>
<summary>✅ v1.1 Internal Billing API (Phases 5-6) — SHIPPED 2026-04-03</summary>

- [x] Phase 5: Internal Auth and Reserve (2/2 plans) — completed 2026-04-02
- [x] Phase 6: Settle, Release, and Verification (2/2 plans) — completed 2026-04-03
